...
<script type="text/javascript">
    $(function () {
		...
		$("#saveTranBtn").click(function () {
			...
			activityId = $("#create-activity").val()
			contactsId = $("#create-contact").val()
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-accountName" placeholder="不存在则创建用户,此处使用默认值" readonly value="大润发杀鱼匠有限公司">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-transactionType">
				  <option></option>
					<c:forEach items="${transactionTypeList}" var="u">
						<option value="${u.id}">${u.value}</option>
					</c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-source">
					<option></option>
					<c:forEach items="${sourceList}" var="u">
						<option value="${u.id}">${u.value}</option>
					</c:forEach>
				</select>
			</div>
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-activity">
					<option></option>
					<c:forEach items="${activityList}" var="u">
						<option value="${u.id}">${u.name}</option>
					</c:forEach>
				</select>
			</div>
